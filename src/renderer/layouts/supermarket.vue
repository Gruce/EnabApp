...
.bg {
  ...
  background: -webkit-linear-gradient(to right, #3d81ff, #1f6dff);  /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #3d81ff, #1f6dff); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
