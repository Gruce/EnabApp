<template>
  <div>
    <ul class="nav flex-column pr-0">
      ...
      <nuxt-link to="/">
        <li class=" nav-item pointer content text-center text-light py-4 mt-3" v-b-tooltip.hover.left title="الذهاب الى قائمة الخدمات"> <i class="fas fa-arrow-left fa-2x"></i> </li>
      </nuxt-link>
